...
class EsgCheckDescription(StakeholderBaseSchema, table=True):
    id: uuid.UUID = Field(
        sa_column=Column(
    ...
    esgcheckdescription_created_by: uuid.UUID = Field(foreign_key="user.id", nullable=False)
 
    esgcheckdescription_updated_by: Optional[uuid.UUID] = Field(default=None, foreign_key="user.id")
