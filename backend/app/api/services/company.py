...
#     user_id: UUID, next_of_kin_data: CompanyCreateSchema, session: AsyncSession
# ) -> CompanyReadSchema:
#     try:
#         current_count = await validate_company_creation(
...
#         logger.error(f"Failed to create companies: {str(e)}")
#         raise HTTPException(
